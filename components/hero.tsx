        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-16 items-start">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Забезпечую повноцінну комунікацію між українським та японським бізнесом,
              адаптуючи запити сторін до соціокультурних та юридичних парадигм обох країн.
              Багаторічний досвід у японських корпораціях дає мені чітке розуміння механізмів
              ухвалення рішень — і того, чому звична нам логіка тут не завжди є запорукою успіху.
            </p>
