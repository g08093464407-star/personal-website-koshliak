...
const articles = [
  ...
  },
  {
    ...
    date: "Практика",
    summary:
      "Рішення рідко приймають за столом переговорів. Важливо знати, де насправді формується позиція, хто схвалює рішення і як правильно обрати сторону комунікації",
  ...
  },
  {
    ...
    date: "Принципи",
    summary:
      "Реальність замість зручного сценарію самоствердження: чесна оцінка на старті часто дешевша за кризове втручання згодом.",
